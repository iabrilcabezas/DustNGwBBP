...
out_base=/global/cfs/cdirs/act/data/iabril/BBPower/230725/sims/ #03_pte

wtypes='w dfwt'

for i in {50000..54999}
do
echo ${i}
...
python -m bbpower BBCompSep --cells_fiducial=${base_folder}/${rubbish}_fid.fits --cells_noise=${base_folder}/${rubbish}_noi.fits --cells_coadded=${base_folder}/${rubbish}_tot.fits --config=${outdir}/bestfitcell.yml --output_dir=${outdir}
